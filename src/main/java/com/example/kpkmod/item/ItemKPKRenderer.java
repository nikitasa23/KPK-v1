...
public class ItemKPKRenderer extends TileEntityItemStackRenderer {
    ...
    private void renderRegistrationForm(boolean interactionGuiOpen, FloatBuffer mv, FloatBuffer proj, IntBuffer vp, ScaledResolution sr) {
        ...
        String[] values = {"", "", "", "", ""};
        if (mc.currentScreen instanceof com.example.kpkmod.gui.KPKModelInteractionGui) {
            com.example.kpkmod.gui.KPKModelInteractionGui gui = (com.example.kpkmod.gui.KPKModelInteractionGui) mc.currentScreen;
    ...
    private void renderChannelList(ItemStack stack, boolean interactionGuiOpen, FloatBuffer mv, FloatBuffer proj, IntBuffer vp, ScaledResolution sr) {
        ...
        if (currentChannelId == null || currentChannelId.trim().isEmpty()) {
            currentChannelId = com.example.kpkmod.chat.ChatChannel.COMMON_CHANNEL_ID_PREFIX;
        }
